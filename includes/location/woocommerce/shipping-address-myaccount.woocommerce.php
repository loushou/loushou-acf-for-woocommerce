...
class LOU_ACF_WC_Shipping_Address_My_Account extends LOU_ACF_Location {
	...
	protected function initialize() {
		$this->slug = 'wc-my-account-shipping-address';
		$this->name = __( 'My Account - Edit Shipping Address', 'lou-acf-wc' );
		...
		add_action( 'woocommerce_after_edit_address_form_shipping', array( &$this, 'add_fields' ), 100 );
	...
	public function save_address( $user_id, $address_type ) {
		// if this is not the shipping fields save, then bail
...
if ( defined( 'ABSPATH' ) && function_exists( 'add_action' ) )
	LOU_ACF_WC_Shipping_Address_My_Account::instance();
